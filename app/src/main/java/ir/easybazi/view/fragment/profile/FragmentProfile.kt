package ir.easybazi.view.fragment.profile
...
import ir.easybazi.api_service.payment.FinanceService
import ir.easybazi.api_service.ticket.TicketService
import ir.easybazi.model.Finance
...
import ir.easybazi.view.activity.*
...
class FragmentProfile : Fragment() {
    ...
    internal lateinit var txt_about_us: TextView
    ...
    internal lateinit var img_instagram: ImageView
    internal lateinit var img_telegram: ImageView
    internal lateinit var lyt_rules: LinearLayout
    internal lateinit var lyt_about_us: LinearLayout
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        lyt_logout.setOnClickListener {
            ...
            alertDialog2.setIcon(R.drawable.abc_dialog_material_background)
...
//            startActivity(intent)
        ...
        img_instagram.setOnClickListener {
            val browserIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://instagram.com/easybazi.ir"))
            startActivity(browserIntent)
        }

        img_telegram.setOnClickListener {
            val browserIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://telegram.me/easybazi"))
            startActivity(browserIntent)
        }


        lyt_rules.setOnClickListener{
            val intent = Intent(context, ActivityWebView::class.java)
            intent.putExtra("URL", "https://easybazi.ir/terms")
            intent.putExtra("ACTIVITY_MODE", true)
        ...
        lyt_about_us.setOnClickListener{
            val intent = Intent(context, ActivityWebView::class.java)
            intent.putExtra("URL", "https://easybazi.ir/about")
            intent.putExtra("ACTIVITY_MODE", true)
    ...
    private fun setupViews() {
        ...
        lyt_rules = view.findViewById(R.id.lyt_rules)
    ...
    private fun setTypeFace() {
        ...
        txt_about_us.typeface = MyViews.getIranSansLightFont(context!!)
