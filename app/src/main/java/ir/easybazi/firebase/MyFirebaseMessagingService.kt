...
import ir.easybazi.api_service.firebase.FireBaseApiService
import ir.easybazi.model.Device
import ir.easybazi.model.Fcm
import ir.easybazi.system.pref_manager.FcmPrefManager
...
//        super.onNewToken(p0)
        ...
        val fcm = Fcm()
        fcm.token = p0
        fcm.client_key = SettingPrefManager(this@MyFirebaseMessagingService).fcmClientKey
        val fcmPrefManager = FcmPrefManager(this@MyFirebaseMessagingService)
    ...
    private fun sendFcmInfoToServer() {
            val fcm =  FcmPrefManager(this@MyFirebaseMessagingService).fcm;
        ...
        val service = FireBaseApiService(this@MyFirebaseMessagingService)
