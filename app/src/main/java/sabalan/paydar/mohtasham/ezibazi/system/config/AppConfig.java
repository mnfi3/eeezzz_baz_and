...
//  public static final String MAIN_URL="http://192.168.1.9/izi-bazi.ud/api";


  public static final int DEFAULT_CITY_ID = 14;//TABRIZ
  public static final int NEW_TICKETS_CHECK_TIME_MS = 10000;
  public static final int TIME_GET_USER_FINANCE_REFRESH_MS = 10000;

  public static final int DEFAULT_VOLLEY_TIME_OUT_MILLIS = 12000;
  public static final int DEFAULT_VOLLEY_RETRY_COUNT = 3;
}
